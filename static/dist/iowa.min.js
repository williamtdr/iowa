...
function loadSummonerPage(){window.location=$(".summoner-region").val().toLowerCase()+"/"+$(".summoner-name-submit").val(),$(".summoner-name-go").html('<i class="fa fa-spin fa-circle-o-notch"></i>')}$(".summoner-name-submit").keyup(function(n){13===event.keyCode&&loadSummonerPage()}),$(".summoner-name-go").click(loadSummonerPage),$(document).ready(function(){$(".animsition").animsition({linkElement:".animsition-link",loading:!0,loadingParentElement:"body",loadingClass:"animsition-loading",browser:["animation-duration","-webkit-animation-duration"]}).on("animsition.inStart",function(){$(".animsition").show(),$(".twitter").attr("href","https://twitter.com/intent/tweet?text=Check%20out%20my%20profile%20on%20the%20Institute%20of%20War%20Aptitude!%20http%3A%2F%2Fiowa.tdr.moe"+window.location.pathname),$(".summoner-name-submit").focus(),$(function(){$("footer").css({position:"absolute",bottom:0}).show()})})});